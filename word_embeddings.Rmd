...
```{r find-synonyms}
fall1 <- search_synonyms(word_vectors,word_vectors["fall",])
slip1 <- search_synonyms(word_vectors,word_vectors["slip",])
```
...
glove_data <- fread(here("../../data/glove.6B/glove.6B.300d.txt"), header = FALSE)
...
**The similarity scores for the GloVe embeddings are much higher overall compared to the climbing accident embeddings. This difference could be due to the climbing data set being much smaller than the glove data set and also having a lot more words that are related to**
